...
-(void)sendIDNRequest:(NSMutableDictionary*)orderDetails withResult:(IDNResult)result{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:[NSURL URLWithString:@"https://secure.ypmn.ru/order/idn.php"] cachePolicy:NSURLRequestReloadIgnoringLocalCacheData timeoutInterval:30.0f];
